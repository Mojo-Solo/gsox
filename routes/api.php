...
//    Route::post('login', 'ApiController@login');
    ...
    Route::group(['middleware' => 'auth:api'],function (){
        ...
        Route::post('Supervisors','ApiController@getSupervisors');
        Route::post('single-Supervisor','ApiController@getSingleSupervisor');
        Route::post('Supervisor-courses','ApiController@getSupervisorCourses');
        Route::post('Supervisor-bundles','ApiController@getSupervisorBundles');
        ...
        Route::post('blog-by-Client','ApiController@getBlogByClient');
