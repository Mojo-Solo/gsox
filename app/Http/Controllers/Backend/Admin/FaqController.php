...
class FaqController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        $has_delete = false;
        $has_edit = false;
        $faqs = Faq::whereHas('Client')->orderBy('created_at', 'desc')->get();
    ...
    public function create()
    {
        ...
        return view('backend.faqs.create',compact('Client'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.faqs.edit', compact('faq','Client'));
    }
