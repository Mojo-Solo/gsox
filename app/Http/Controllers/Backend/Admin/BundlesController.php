...
class BundlesController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $id = request('cat_id');
            $bundles = Bundle::ofAuthor()->where('client_id', '=', $id)->orderBy('created_at', 'desc')->get();
        } else {
    ...
    public function create()
    {
        ...
        $courses = Course::ofSupervisor()->pluck('title', 'id');
        $Clients = Client::where('status', '=', 1)->pluck('name', 'id');

        return view('backend.bundles.create', compact('courses', 'Clients'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.bundles.edit', compact('bundle', 'courses', 'Clients'));
    }
