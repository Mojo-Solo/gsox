...
class BlogController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        $blogs = Blog::query()->whereHas('Client')->orderBy('created_at', 'desc')->get();
    ...
    public function create()
    {
        ...
        $Client = Client::pluck('name','id')->prepend('Please select', '');
        return view('backend.blogs.create', compact('Client'));
    ...
    public function edit($id)
    {
        ...
        return view('backend.blogs.edit', compact('blog', 'Client', 'tags'));
    ...
    /**
     * Get list of blogs belongs to a Client.
     * @param $slug
     * @return Response
     */

    public function getClientBlog($slug)
    {
        $Client = Client::where('slug', '=', $slug)->first();
        $blogs = $Client->blogs()->paginate(10);
        if ($Client != null) {
            return view('blog.frontend.Client-blogs', compact('blogs', 'Client'));
        } else {
            return response(view(404), 404);
        }
    }
