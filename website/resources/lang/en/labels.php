...
return array (
  ...
  array (
    ...
    array (
      ...
      'add_teachers' => 'Add Site Admins',
      'add_categories' => 'Add Clients',
      'slug_placeholder' => 'Input slug or it will be generated automatically',
      'select_category' => 'Select Client',
      'select_teachers' => 'Select Site Admins',
      'test' => 'Test',
      'lesson' => 'Lesson',
...
<b>Live</b> = Will be used with you Live PayPal credentials to make actual transaction with normal users with PayPal account.',
      ...
      'counter' => 'Counter',
      'counter_note' => '<b>Static</b> =  Manually add data for counter. Please enter exact text you want to display on frontend counter section,<br> <b>Database/Real</b> = It will take real data from database for all the fields (Users enrolled, Total Courses, Total Site Admins)',
      'total_students' => 'Enter Total Users. Ex: 1K, 1Million, 1000 etc.',
      'total_courses' => 'Enter Total Courses. Ex: 1K, 1000 etc.',
      'total_teachers' => 'Enter Total Site Admins. Ex: 1K, 1000 etc.',
    ...
    array (
      ...
      'students_enrolled' => 'Users Enrolled To<br> Your Courses',
  ...
  array (
    ...
    array (
      ...
      'blog_categories' => 'Blog <span>Clients.</span>',
    ...
    array (
      ...
      'buy_note' => 'Only Users Can Buy Course',
    ...
    array (
      ...
      array (
        ...
        'primary' => 'Primary',
        'second' => 'Second',
        'courses_categories' => 'Courses Clients',
        'browse_course_by_category' => 'Browse Courses<span> By Client.</span>',
        ...
        'sponsors' => 'Sponsors.',
        'students_testimonial' => 'Users <span>Testimonial.</span>',
    ...
    array (
      ...
      'students' => 'Users',
      'title' => 'Site Admins',
      'courses_by_teacher' => 'Courses <span>By Site Admin.</span>',
      'course_detail' => 'Course Detail',
    ),
    'user' => 
    array (
    ...
    array (
      'popular_courses' => 'Popular courses',
      'popular_categories' => 'Popular Clients',
      'featured_courses' => 'Featured Courses',
      'trending_courses' => 'Trending Courses',
