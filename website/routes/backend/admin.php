...
Route::group(['middleware' => ['checkRole:administrator|teacher|vendor']], function () {
    //===== Vendors Routes =====//
    Route::resource('getusers', 'Admin\SiteAdminUsersController');
    Route::get('get_users_data', ['uses' => 'Admin\SiteAdminUsersController@getData', 'as' => 'siteadminusers.get_data']);
    Route::post('users_mass_destroy', ['uses' => 'Admin\SiteAdminUsersController@massDestroy', 'as' => 'getusers.mass_destroy']);
    Route::post('users_restore/{id}', ['uses' => 'Admin\SiteAdminUsersController@restore', 'as' => 'siteadminusers.restore']);
    Route::delete('users_perma_del/{id}', ['uses' => 'Admin\SiteAdminUsersController@perma_del', 'as' => 'siteadminusers.perma_del']);
});
