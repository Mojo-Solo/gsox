...
Route::get('{category}', ['uses' => 'CoursesController@getByCategory', 'as' => 'courses.category']);
...
Route::group(['middleware' => 'auth'], function () {
    Route::get('lesson/{course_id}/{slug}/{type}', ['uses' => 'LessonsController@show', 'as' => 'lessons.show']); 
    Route::post('lesson/{slug}/test', ['uses' => 'LessonsController@test', 'as' => 'lessons.test']);
    Route::post('lesson/{slug}/testapi', ['uses' => 'LessonsController@testapi', 'as' => 'lessons.testapi']);
