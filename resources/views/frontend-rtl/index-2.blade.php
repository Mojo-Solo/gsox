...
@section('content')
   ...
   @endif
    ...
    @if($sections->course_by_Client->status == 1)
        <!-- Start Course Client
        ============================================= -->
        <section id="course-Client" class="course-Client-section home-secound-version">
            <div class="container">
                <div class="section-title mb20 headline text-left">
                    <span class="subtitle ml42 text-uppercase">@lang('labels.frontend.layouts.partials.courses_Clients')</span>
                    <h2>@lang('labels.frontend.layouts.partials.browse_course_by_Client')</h2>
                </div>
                <div class="Client-item Client-slide-item">
                    @if($course_Clients)
                        @foreach($course_Clients as $key=>$Client)
                            @if($key%2 == 0)
    ...
    @if($sections->Supervisors->status == 1)
        <!-- Start secound Supervisor section
        ============================================= -->
    <section id="Supervisor-2" class="secound-Supervisor-section">
        <div class="container">
            <div class="section-title mb35 headline text-left">
                ...
                <h2>{{env('APP_NAME')}} <span>@lang('labels.frontend.home.Supervisors').</span></h2>
            </div>
            <div class="Supervisor-secound-slide">
                @if(count($Supervisors)> 0)
                    @foreach($Supervisors as $item)
                        <div class="Supervisor-img-text relative-position text-center">
                            <div class="Supervisor-img-social relative-position" >
                                <img height="200px" width="200px" src="{{$item->picture}}" alt="{{$item->full_name}}">
                                <div class="blakish-overlay"></div>
                                <div class="Supervisor-social-list ul-li">
                                    <ul>
                            ...
                            <div class="Supervisor-name-designation mt15">
            ...
            <div class="genius-btn gradient-bg text-center text-uppercase ul-li-block bold-font">
                <a href="{{route('Supervisors.index')}}">@lang('labels.frontend.home.all_Supervisors') <i class="fas fa-caret-right"></i></a>
            </div>
        </div>
    </section>
