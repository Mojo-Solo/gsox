        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold"><span>@if(isset($Client)) {{$Client->name}} @else @lang('labels.frontend.course.courses') @endif </span></h2>
                </div>
            </div>
        </div>
    </section>
                                                ...
                                                <div class="best-course-pic-text relative-position">
                                                    ...
                                                    <div class="best-course-text">
                                                        ...
                                                        <div class="course-meta">
                                                            <span class="course-Client"><a href="{{route('courses.Client',['Client'=>$course->Client->slug])}}">{{$course->Client->name}}</a></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="course-type-list">
                                                        <span><a href="{{route('courses.Client',['Client'=>$course->Client->slug])}}">{{$course->Client->name}}</a></span>
                                                    </div>
                                                </td>
                                        ...
                                        <select name="Client" class="form-control listing-filter-form select">
                                            ...
                                            @if(count($Clients) > 0)
                                                @foreach($Clients as $Client)
                                                    <option @if(request('Client') && request('Client') == $Client->id) selected
