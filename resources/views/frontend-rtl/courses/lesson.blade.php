                        ...
                        <div class="couse-feature ul-li-block">
                            <ul>
                                ...
                                <li>@lang('labels.frontend.course.Client') <span><a
                                                href="{{route('courses.Client',['Client'=>$lesson->course->Client->slug])}}"
                                                target="_blank">{{$lesson->course->Client->name}}</a> </span></li>
                                <li>@lang('labels.frontend.course.author') <span>

                   @foreach($lesson->course->Supervisors as $key=>$Supervisor)
                                            @php $key++ @endphp
                                            <a href="{{route('Supervisors.show',['id'=>$Supervisor->id])}}" target="_blank">
                           {{$Supervisor->full_name}}@if($key < count($lesson->course->Supervisors )), @endif
                       </a>
                                        @endforeach
