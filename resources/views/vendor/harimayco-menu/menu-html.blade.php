                                                                        ...
                                                                        @if($pages->count() > 0)
                                                                            @foreach($pages as $item)
                                                                                <div class="checkbox"
                                                                                    ...
                                                                                    {{ html()->label(html()->checkbox('Client[]')->value($item->id).' &nbsp;'.$item->title)}}
                                                                                </div>
                                                                            @endforeach
                                                                        @endif
                                                                    </div>
...
@push('after-scripts')
    <script>
        ...
        //Custom-link, post, page, Client add to menu.
        $(document).on('click', '.add-to-menu', function () {
            ...
            if (checked.length > 0) {
                $(checked).each(function () {
                    if ($(card).find('.checkbox-wrapper').hasClass('Client')) {
                        link = $(location).attr('protocol') + '//' + $(location).attr('hostname') + '/Client';
                        type = 'Client';
