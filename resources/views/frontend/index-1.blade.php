...
@push('after-styles')
    <style>
        ...
        /*line-height: 60px;*/
        /*}*/
        .Supervisor-img-content .Supervisor-social-name{
            max-width: 67px;
        }
        .my-alert{
            position: absolute;
...
@section('content')
    ...
    @if($sections->Supervisors->status == 1)
        <!-- Start of course Supervisor
        ============================================= -->
        <section id="course-Supervisor" class="course-Supervisor-section">
            <div class="jarallax">
                <div class="container">
                    <div class="section-title mb20 headline text-center ">
                        ...
                        <div class="row justify-content-center">
                            ...
                            @if(count($Supervisors)> 0)
                                @foreach($Supervisors as $item)
                                    <div class="col-md-3">
                                        <div class="Supervisor-img-content ">
                                            <div class="Supervisor-cntent">
                                                ...
                                                <div class="Supervisor-img-Client">
