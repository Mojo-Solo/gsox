...
@else
    ...
    <!-- Start of Header section
        ...
        <header>
            ...
            {{-- <div class="alert alert-warning text-center" style="margin-bottom: 0px!important">
                <strong>Alert!</strong> Technical Assistance will be available up until 12:00 PM Central Time Thursday December 17, 2020,<br>and Normal Technical Assistance will resume Monday January 4, 2021.
            </div> --}}
                        ...
                        <div class="navbar-default">
                            ...
                            <nav class="navbar-menu float-right">
                                <div class="nav-menu ul-li">
                                    <ul>
                                        <li>
                                            <a class="nav-link {{ active_class(Active::checkRoute('frontend.certificates.getVerificationForm')) }}" href="{{url('certificate-verification')}}">Verify Certificate</a>
                                        </li>
                                        ...
                                        @elseif(auth()->guard('vendor')->check())
                                            <li class="menu-item-has-children ul-li-block">
                                                <a href="#!">{{ (!empty(auth()->guard('vendor')->user()->contact_name)?auth()->guard('vendor')->user()->contact_name:(auth()->guard('vendor')->user()->company_name)?auth()->guard('vendor')->user()->company_name:'') }}</a>
                                                <ul class="sub-menu">
                                                    <li>
                                                        <a href="{{ route('admin.dashboard') }}">@lang('navs.frontend.dashboard')</a>
                                                    </li>
    ...
    <?php if(\Session::has('message')) { $message=\Session::get('message');\Session::forget('message'); ?>
     <script>swal("Success!", "{{$message}}!", "success");</script>
     <?php } elseif(\Session::has('error')) { $message=\Session::get('error');\Session::forget('error'); ?>
