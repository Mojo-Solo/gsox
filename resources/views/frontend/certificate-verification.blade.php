                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="contact-info">
                                        <input class="name" value="{{(session('data')['uid']) ? session('data')['uid'] : old('uid')}}" name="uid" type="text" placeholder="Enter ID code printed on the bottom of certificate">
                                        @if($errors->has('uid'))
                                            <span class="help-block text-danger">{{$errors->first('uid')}}</span>
                                        @endif
                                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach(session('data')['certificates'] as $certificate)
                                            <tr>
                                                ...
                                                <td><a target="_blank" href="{{asset('storage/certificates/'.$certificate->url)}}"
