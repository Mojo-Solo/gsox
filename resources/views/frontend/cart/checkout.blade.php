...
<?php 
$manager=0;
if(\Session::has('user_sposor') && \Session::get('user_sposor')=="manager") {
    $manager=1;
}
?>
            ...
            <div class="checkout-content">
                <div class="row">
                    <div class="col-md-9">
                                                        ...
                                                        <div class="course-list-text">
                                                            ...
                                                            <div class="course-meta">
                                                                ...
                                                                <span class="course-Client bold-font"><a
                                                                        ...
                                                                        @endif</a></span>
                                                                @endif
                                                                <span class="bold-font">{{$course->Client->name}}</span>
                        ...
                        @if(count($courses) > 0)
                            @if((config('services.stripe.active') == 0) && (config('services.authorize.active') == 0) && (config('paypal.active') == 0) && (config('payment_offline_active') == 0))
                            ...
                            @else
                                <div class="order-payment">
                                    ...
                                    <div id="accordion">
                                        @if(config('services.stripe.active') == 1 && $offline==0 && !$manager)
                                        ...
                                        @endif
                                        @if(config('services.authorize.active') == 1 && !$manager)
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                               ...
                                                                               value="1"
                                                                               checked>
                                                                        Authorize.net @lang('labels.frontend.cart.payment_cards')
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="check-out-form collapse show" id="collapsePaymentOne"
                                                    ...
                                                    <form accept-charset="UTF-8"
                                                          action="{{route('cart.authorize.payment')}}"
                                                          class="require-validation" data-cc-on-file="false"
                                                          id="payment-form"
                                                          method="POST">
                                                        ...
                                                        <div class="payment-info input-2">
                                                            ...
                                                            <input autocomplete='off' type="text"
                                                                   class="form-control required card-expiry-month"
                                                                   placeholder="@lang('labels.frontend.cart.mm')"
                                                                   value="" required name="card_expiry_month">
                                                            <input autocomplete='off' type="text"
                                                                   class="form-control required card-expiry-year"
                                                                   placeholder="@lang('labels.frontend.cart.yy')@lang('labels.frontend.cart.yy')"
                                                                   value="" required name="card_expiry_year">
                                                        </div>
                                                        <button type="submit"
                                                                class="text-white genius-btn mt25 gradient-bg text-center text-uppercase  bold-font">
                                                            @lang('labels.frontend.cart.pay_now') with Authorize.net <i
                                                                    class="fas fa-caret-right"></i>
                                                        </button>
                                                        <div class="row mt-3">
                                                            <div class="col-12 error form-group d-none">
                                        ...
                                        @if(config('paypal.active') == 1 && $offline==0 && !$manager)
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                        ...
                                        @if(config('payment_offline_active') == 1 || $offline==1)
                                        @if(\Auth::user()->hasRole('student') && isset(\Auth::user()->vendor) && \Auth::user()->vendor->invoicing)
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        <div class="col-md-6">
