            ...
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold">
                        <span>@if(isset($Client)) {{$Client->name}} @else @lang('labels.frontend.course.bundles') @endif </span>
                    </h2>
                </div>
            </div>
        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="course-type-list">
                                                            <span><a href="{{route('courses.Client',['Client'=>$bundle->Client->slug])}}">{{$bundle->Client->name}}</a></span>
                                                        </div>
                                                    </td>
