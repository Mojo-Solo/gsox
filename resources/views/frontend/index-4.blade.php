...
@section('content')
    ...
    @if($sections->course_by_Client->status == 1)
        <!-- Start of Clients
    ============================================= -->
        <div class="about-course-categori one-page-Client about-Supervisor-2">
            <div class="container">
                <div class="Client-slide text-center">
                    @if($course_Clients->count() > 0)
                        @foreach($course_Clients as $Client)
    ...
    ============================================= -->
        <section id="genius-Supervisor-2" class="genius-Supervisor-section-2 one-page-Supervisor backgroud-style">
            <div class="container">
