    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-12 col-lg-4 form-group">
                {!! Form::label('title', trans('labels.backend.Clients.fields.name').' *', ['class' => 'control-label']) !!}
                {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Enter Client Name', 'required' => false]) !!}
            ...
            <div class="col-12 col-lg-2  form-group">
                ...
                {!! Form::label('icon',  trans('labels.backend.Clients.fields.select_icon'), ['class' => 'control-label  d-block']) !!}
