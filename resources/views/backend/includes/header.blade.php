    ...
    <ul class="nav navbar-nav ml-auto mr-4">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            @endphp
            <img src="{{ $image }}" class="img-avatar" alt="{{ $logged_in_user->email }}">
            <span style="right: 0;left: inherit" class="badge d-md-none d-lg-none d-none mob-notification badge-success">!</span>
            <span class="d-md-down-none">{{ $logged_in_user->contact_name }}</span>
            @elseif($logged_in_user->hasRole('student'))
