    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @if ($logged_in_user->isAdmin())
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'Supervisors' ? 'active' : '' }}"
                       href="{{ route('admin.Supervisors.index') }}">
                        <i class="nav-icon icon-directions"></i>
                        <span class="title">@lang('menus.backend.sidebar.Supervisors.title')</span>
                    </a>
                </li>
            @endif
            @can('client_access')
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'Clients' ? 'active' : '' }}"
                       href="{{ route('admin.Clients.index') }}">
                        ...
                        <span class="title">@lang('menus.backend.sidebar.Clients.title')</span>
                    </a>
                </li>
            @endif
            @endcan
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $request->segment(1) == 'vendors' ? 'active' : '' }}"
                               href="{{ route('admin.reports.vendors') }}">Reporting By Vendor
                            </a>
                        </li>
                        @endif
                        @endif
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @if ($logged_in_user->isAdmin())
                            ...
                            <li class="nav-item ">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link {{ $request->segment(2) == 'forums-Client' ? 'active' : '' }}"
                                       href="{{ route('admin.forums-Client.index') }}">
                                        <span class="title">@lang('menus.backend.sidebar.forums-Client.title')</span>
                                    </a>
                                </li>
                            <li class="nav-item ">
            ...
            @if($logged_in_user->isAdmin())
            <li class="nav-item ">
                <a class="nav-link {{ $request->segment(1) == 'mailbox' ? 'active' : '' }}"
                   href="{{ route('admin.mailbox') }}">
                    <i class="nav-icon icon-envelope"></i> <span
                            class="title">Mail Box</span>
                </a>
            </li>
            @endif
            ...
            @if((!$logged_in_user->isAdmin() && $logged_in_user->hasAnyPermission(['vendor_management_access'])) || (!$logged_in_user->isAdmin() && $logged_in_user->hasAnyPermission(['student_management_access'])) || auth()->guard('vendor')->check())
            <li class="nav-item nav-dropdown {{(Request::segment(2)=='students' || Request::segment(2)=='vendors')?'open':''}}">
