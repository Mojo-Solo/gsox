...
@section('title', __('Chapters').' | '.app_name())
        ...
        <div class="card-body">
            <div class="d-block">
                ...
                <div class="table-responsive">
                    ...
                    <table id="myTable"
                           class="table table-bordered table-striped @can('chapter_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                        <thead>
                        <tr>
                            @can('chapter_delete')
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.chapters.get_data')}}';


            @php
                $show_deleted = (request('show_deleted') == 1) ? 1 : 0;
                $id = (request('id') != "") ? request('id') : 0;
            $route = route('admin.chapters.get_data',['show_deleted' => $show_deleted,'id' => $id]);
            @endphp
