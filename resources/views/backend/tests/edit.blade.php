...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="input-group mb-3 col-4 form-group">
                  <input type="number" name="passing_percentage" value="{{$test->passing_percentage}}" class="form-control" placeholder="Passing Percentage" aria-label="Passing Percentage" aria-describedby="basic-addon2">
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    ...
                    {!! Form::checkbox('show_answers', 1, old('show_answers'), []) !!}
                    {!! Form::label('show_answers', 'Display correct/incorrect answers after test is completed?', ['class' => 'control-label font-weight-bold']) !!}
