...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                <h3 class="page-title d-inline">@lang('labels.backend.Supervisors.title')</h3>
            @can('course_create')
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.Supervisors.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.Supervisors.fields.first_name')</th>
                                <th>@lang('labels.backend.Supervisors.fields.last_name')</th>
                                <th>@lang('labels.backend.Supervisors.fields.email')</th>
                                <th>@lang('labels.backend.courses.fields.Client')</th>
                                <th>@lang('labels.backend.Supervisors.fields.status')</th>
                                @if( request('show_deleted') == 1 )
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.Supervisors.get_data')}}';

            @if(request('show_deleted') == 1)
                route = '{{route('admin.Supervisors.get_data',['show_deleted' => 1])}}';
            @endif
