...
@section('content')
    {{ html()->form('POST', route('admin.Supervisors.store'))->acceptsFiles()->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('labels.backend.Supervisors.create')</h3>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ Form::select('client_id', $clients, null,['class'=>'select2 form-control','required','id' => 'client_id']) }}
                        </div><!--col-->
                    </div>
