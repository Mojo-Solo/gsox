    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.questions.preview',$question->id) }}" target="_blank" class="btn btn-success">View Question</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('review_topic_id', 'Select Review Topic', ['class' => 'control-label']) !!}
                    {!! Form::select('review_topic_id', $topics,  (request('review_topic_id')) ? request('review_topic_id') : old('review_topic_id'), ['class' => 'form-control select2']) !!}
                </div>
            </div>
            @endif
        </div>
    ...
    @foreach ($question->options as $key=>$option)
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12 form-group">
                        {!! Form::label('option_text_' . $option->id, $key."). ".trans('labels.backend.questions.fields.option_text').'*', ['class' => 'control-label']) !!}
