...
@section('content')
    ...
    <div class="card">
        ...
        @if(Auth::user()->hasRole('Supervisor') && empty(Auth::user()->client_id))
        <div class="card-body">
            <h3 class="text-center">You are not linked with any client, please contact with admin.</h3>
        </div>
        @else
        <div class="card-body">
            @if (Auth::user()->isAdmin())
                <div class="row">
                    <div class="col-10 form-group">
                        ...
                        {!! Form::select('Supervisors[]', $Supervisors, old('Supervisors'), ['class' => 'form-control select2 js-example-placeholder-multiple','required' ,'multiple' => 'multiple']) !!}
                    </div>
            ...
            <div class="row">
                <div class="col-10 form-group">
                    ...
                    {!! Form::select('client_id', $Clients, old('client_id'), ['class' => 'form-control select2 js-example-placeholder-single','required' ,'multiple' => false]) !!}
                </div>
                <div class="col-2 d-flex form-group flex-column">
                    OR <a target="_blank" class="btn btn-primary mt-auto"
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 form-group">
                    {!! Form::label('course_header_image',  trans('labels.backend.courses.fields.course_header_image'), ['class' => 'control-label']) !!}
                    {!! Form::file('course_header_image',  ['class' => 'form-control', 'accept' => 'image/jpeg,image/gif,image/png']) !!}
