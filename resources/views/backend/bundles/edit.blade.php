        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-10 form-group">
                    ...
                    {!! Form::select('courses[]', $courses, old('Supervisors') ? old('Supervisors') : $bundle->courses->pluck('id')->toArray(), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple']) !!}
                </div>
            ...
            <div class="row">
                ...
                <div class="col-2 d-flex form-group flex-column">
                    OR <a target="_blank" class="btn btn-primary mt-auto"
                          href="{{route('admin.Clients.index').'?create'}}">{{trans('labels.backend.bundles.add_Clients')}}</a>
                </div>
            </div>
            <div class="row">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".js-example-placeholder-single").select2({
                placeholder: "{{trans('labels.backend.bundles.select_Client')}}",
            });
