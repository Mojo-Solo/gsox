                    ...
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="counter-container" id="counter-container">
                                        ...
                                        <input type="text" required class="form-control mb-2" id="total_Supervisors"
                                               name="total_Supervisors"
                                               placeholder="{{__('labels.backend.general_settings.total_Supervisors')}}">
                                    </div>
                            ...
                            <div class="input-group row">
                                <label class="col-md-2 form-control-label" for="course_lesson_timer">Course Next Button Time</label>
                                <div class="col-md-10 input-group">
                                    <input type="number" class="form-control" name="course_lesson_timer" value="{{(empty(config('course_lesson_timer')))?8:config('course_lesson_timer')}}">
                                    <div class="input-group-append" style="padding-bottom: 43px;">
                                        <span class="input-group-text" id="basic-addon2">Seconds</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                {{ html()->label(__("Randomizer"))->class('col-md-2 form-control-label')->for('option_randomizer') }}
                                <div class="col-md-10">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('option_randomizer', config('option_randomizer') ? true : false,1)->id('option_randomizer')
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
                                    </div>
                                    <small><i> {{__('Enable / Disable to randomize the options of all questions')}}</i></small>
                                </div><!--col-->
                            </div><!--form-group-->
                            <div class="form-group row">
                ...
                <div id="payment_settings" class="tab-pane container fade">
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('Authorize.net Payment Method'))->class('col-md-3 form-control-label')->for('services.authorize.active') }}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('services__authorize__active', config('services.authorize.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                    ...
                                    <div class="switch-content @if(config('services.authorize.active') == 0 || config('services.authorize.active') == false) d-none @endif">
                                        <br>
                                        <div class="form-group row">
                                            {{ html()->label(__('AUTHORIZE_PAYMENT_API_LOGIN_ID'))->class('col-md-2 form-control-label')->for('services.authorize.login') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('services__authorize__login')
                                                     ->class('form-control')
                                                     ->value(config('services.authorize.login'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        <div class="form-group row">
                                            {{ html()->label(__('AUTHORIZE_PAYMENT_TRANSACTION_KEY'))->class('col-md-2 form-control-label')->for('services.authorize.key') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('services__authorize__key')
                                                     ->class('form-control')
                                                     ->value(config('services.authorize.key'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                    </div>
                    ...
                    <div class="row mt-4 mb-4">
                        ...
                        <div class="col-lg-3 border-left col-12">
                            <div class="form-group input-list">
                                ...
                                <div class="checkbox">
                                    <label><input class="option" type="checkbox" data-name="vendor" data-type="text"
                                                  value=""> Vendor</label>
                                </div>
                            </div>
                        </div>
...
@push('after-scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#total_Supervisors').val("{{config('total_Supervisors')}}");
