    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('Client', trans('labels.backend.blogs.fields.Client'), ['class' => 'control-label']) !!}
                    {!! Form::select('Client', $Client,  (request('Client')) ? request('Client') : old('Client'), ['class' => 'form-control select2']) !!}
                </div>
