                            ...
                            @if(count($certificates) > 0)
                                @foreach($certificates as $key=>$certificate)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$certificate->course->progress($certificate->user_id) }}%</td>
                                        <th>
                                            @if($certificate->course->progress($certificate->user_id) == 100)
                                                <a href="{{asset('storage/certificates/'.$certificate->url)}}" target="_blank" class="btn btn-success">
