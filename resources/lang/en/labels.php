  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'course_header_image' => 'Course Header Image',
    ...
    array (
      ...
      'short_description_placeholder' => 'Input short description of topic',
...
<p class="mb-1"><b>Embed :</b> Copy / Paste embed code in above text box</p>',
    ...
    array (
      ...
      array (
        ...
        'popular_Clients' => 'Popular Clients',
...
<b>Live</b> = Will be used with you Live PayPal credentials to make actual transaction with normal users with PayPal account.',
      ...
      'counter' => 'Counter',
      'counter_note' => '<b>Static</b> =  Manually add data for counter. Please enter exact text you want to display on frontend counter section,<br> <b>Database/Real</b> = It will take real data from database for all the fields (Students enrolled, Total Courses, Total Supervisors)',
      'total_students' => 'Enter Total Students. Ex: 1K, 1Million, 1000 etc.',
      'total_courses' => 'Enter Total Courses. Ex: 1K, 1000 etc.',
      'total_Supervisors' => 'Enter Total Supervisors. Ex: 1K, 1000 etc.',
      'layout_type' => 'Layout Type',
      'theme_layout' => 'Theme Layout',
      'layout_note' => 'This will change frontend theme layout',
      'show_offers_note' => 'Enable / Disable if Code offers page link to be displayed in bottom footer',
      'newsletter' => 
      array (
    ...
    array (
      ...
      'per_user_limit_note' => 'Specify how many times a single user can use this Code. By default one time use.',
      'total_note' => 'Number of Codes to be issued',
      'fields' => 
      array (
        'name' => 'Name',
        'code' => 'Code',
    ...
    array (
      'title' => 'Forum Clients',
      'create' => 'Create Forum Client',
      'edit' => 'Edit Forum Client',
      'view' => 'View Forum Client',
      'on' => 'On',
      'off' => 'Off',
      'fields' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'blog_Clients' => 'Blog <span>Clients.</span>',
    ...
    array (
      ...
      'offline_payment' => 'Invoice my Employer',
      ...
      'request_assistance' => 'Submit order for approval',
      'cart' => 'Cart',
      'checkout' => 'Checkout',
      ...
      'offline_request' => 'Request received successfully!',
      ...
      'item' => 'item',
      'offers' => 'Offers',
      'empty_input' => 'Write code code before applying',
    ...
    array (
      ...
      'popular_Supervisors' => '<span>Popular</span> Supervisors',
    ...
    array (
      ...
      array (
        ...
        'primary' => 'Primary',
        'second' => 'Second',
        'courses_Clients' => 'Courses Clients',
        'browse_course_by_Client' => 'Browse Courses<span> By Client.</span>',
    ...
    array (
      ...
      'students' => 'Students',
      'title' => 'Supervisors',
      'courses_by_Supervisor' => 'Courses <span>By Supervisor.</span>',
      'course_detail' => 'Course Detail',
    ),
    'user' => 
    array (
