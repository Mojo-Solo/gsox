...
!function (a) {
    ...
    b = wpNavMenu = {
            ...
            a.fn.extend({
                ...
                addSelectedToMenu: function (c) {
                    return 0 === a("#menu-to-edit").length ? !1 : this.each(function () {
                        var d = a(this),
                            e = {},
                            f = d.find(menus.oneThemeLocationNoMenus && 0 === d.find(".tabs-panel-active .Clientchecklist li input:checked").length ? '#page-all li input[type="checkbox"]' : ".tabs-panel-active .Clientchecklist li input:checked"),
                            g = /menu-item\[([^\]]*)/;
        ...
        processQuickSearchQueryResponse: function (b, c, d) {
            ...
            }), a(".Clientchecklist", d).html(k), void a(".spinner", d).hide()) : (a(".Clientchecklist", d).html("<li><p>" + navMenuL10n.noResultsFound + "</p></li>"), void a(".spinner", d).hide())
        },
